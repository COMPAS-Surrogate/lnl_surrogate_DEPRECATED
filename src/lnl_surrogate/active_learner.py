...
from trieste.experimental.plotting import plot_gp_2d, plot_regret
...
def train_and_save_lnl_surrogate(
    ...
    learning_rules = [
        EfficientGlobalOptimization(aq_fn) for aq_fn in acquisition_fns
    ]
